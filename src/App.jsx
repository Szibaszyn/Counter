...
function App() {
  ...
  return (
    <>
      <div className="card">
        <button
          className="bigger add"
          onClick={() => handleClick(1, "#70fff8", "#2cbfb8")}
        >
          +
        </button>
        <button
          className="bigger add"
          onClick={() => handleClick(10, "#70fff8", "#2cbfb8")}
        >
          +10
        </button>
        <button
          className="bigger add"
          onClick={() => handleClick(100, "#70fff8", "#2cbfb8")}
        >
          +100
        </button>
        <br></br>
        ...
        <button
          className="function"
          onClick={() => handleClick(-count, "#ffffff", "#ffffff")}
        >
          Reset
        </button>
        <br></br>
        <button
          className="bigger unadd"
          onClick={() => handleClick(-1, "#8121ad", "#8f32ba")}
        >
          -
        </button>
        <button
          className="bigger unadd"
          onClick={() => handleClick(-10, "#8121ad", "#8f32ba")}
        >
          -10
        </button>
        <button
          className="bigger unadd"
          onClick={() => handleClick(-100, "#8121ad", "#8f32ba")}
        >
          -100
        </button>
        <br></br>
      ...
      <div className="tests">
        ...
        <button
          onClick={() => handleClick(-count + count * 10, "#6200ff", "#6200ff")}
        >
          Test_X10
        </button>
        <button
          onClick={() =>
            handleClick(-count + count * 100, "#6200ff", "#6200ff")
          }
        >
          Test_X100
        </button>
